...
training_args = SFTConfig(
    output_dir="saves/model_baseline",
...
model.save_pretrained("saves/model_baseline_final")
...
with open('model_baseline_result.txt', 'w') as file:
    file.writelines(answers)

calculate_accuracy('model_baseline_result.txt')
