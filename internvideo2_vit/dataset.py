    ...
    def _parse_samples(self, data):
        ...
        for entry in data:
            ...
            for c in assistant_msg['content']:
                if c['type'] == 'text' and 'The action happening in this video is:' in c['text']:
                    label_text = c['text'].split('The action happening in this video is:')[-1].strip()
                    break
