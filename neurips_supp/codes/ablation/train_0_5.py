...
from model_0_5 import CustomQwen2VLForConditionalGeneration
...
model = CustomQwen2VLForConditionalGeneration.from_pretrained(
    "saves/base_0_5", torch_dtype="auto", device_map="auto"
)
...
model.save_pretrained("saves/model_0_5_final")
...
with open('model_0_5_result.txt', 'w') as file:
    file.writelines(answers)

calculate_accuracy('model_0_5_result.txt')
