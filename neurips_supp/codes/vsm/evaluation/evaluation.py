        ...
        for line in lines:
            ...
            if line.startswith("Label:"):
                ...
                if current_label and current_response:
                    ...
                    x = "\n".join(current_response).split('system\nYou are a helpful assistant.\nuser\nLook at the provided examples and identify which example is related to the final video.Example 1 -Example 2 -Now consider the previous examples. Is there any action related to this video?If not, respond with \'No related action\'. If there is, respond with the example number.\nassistant\n')
                    res = x[0] if len(x) == 1 else x[1]
...
with open('result_base.txt', "w") as file:
